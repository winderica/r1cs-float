...
pub struct Proof<E: Pairing> {
    ...
    pub cm: Option<E::G1Affine>,
    pub pok: Option<E::G1Affine>,
}
...
pub struct VerifyingKey<E: Pairing> {
    ...
    pub pedersen_g: E::G2Affine,
    pub pedersen_g_inv_neg_sigma: E::G2Affine,
}
...
impl<E: Pairing> Default for VerifyingKey<E> {
    fn default() -> Self {
        Self {
            ...
            pedersen_g: E::G2Affine::default(),
            pedersen_g_inv_neg_sigma: E::G2Affine::default(),
        }
    }
}
...
pub struct ProvingKey<E: Pairing> {
    ...
    pub k_query_sigma: Vec<E::G1Affine>,
}
