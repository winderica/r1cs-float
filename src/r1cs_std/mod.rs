...
#[allow(missing_docs)]
pub mod prelude {
    pub use crate::r1cs_std::{
        alloc::*,
        bits::{boolean::Boolean, ToBitsGadget},
        eq::*,
...
pub trait R1CSVar<F: Field> {
    ...
    /// `crate::r1cs::ConstraintSystemRef::None`.
    fn cs(&self) -> crate::r1cs::ConstraintSystemRef<F>;
    ...
    /// `ConstraintSystem`.
    fn value(&self) -> Result<Self::Value, crate::r1cs::SynthesisError>;
}
...
impl<F: Field, T: R1CSVar<F>> R1CSVar<F> for [T] {
    ...
    fn cs(&self) -> crate::r1cs::ConstraintSystemRef<F> {
        let mut result = crate::r1cs::ConstraintSystemRef::None;
        for var in self {
...
pub trait Assignment<T> {
    ...
    fn get(self) -> Result<T, crate::r1cs::SynthesisError>;
}

impl<T> Assignment<T> for Option<T> {
    fn get(self) -> Result<T, crate::r1cs::SynthesisError> {
        self.ok_or(crate::r1cs::SynthesisError::AssignmentMissing)
    }
}
...
pub trait ToConstraintFieldGadget<ConstraintF: ark_ff::PrimeField> {
    ...
    fn to_constraint_field(
        &self,
    ) -> Result<Vec<crate::r1cs_std::fields::fp::FpVar<ConstraintF>>, crate::r1cs::SynthesisError>;
}
